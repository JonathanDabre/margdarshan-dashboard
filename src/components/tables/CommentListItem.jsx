...
export const CommentListItem = ({profileImage, name, email, role, department, status, id, userName, userComment, adminComment}) => {
  ...
  return (
    <div className="row px-4 flex space-x-2 border-t ">
        ...
        <div className="col-1 w-[20%] flex space-x-4 items-center justify-start">
        ...
        <div className="col-2 w-[10%] pr-[3px] py-4">
            <div className="flex flex-col text-[12px]">
                <div className="role font-semibold text-[#707C95]">{userName}</div>
            </div>
        </div>
        <div className="col-2 w-[10%] pr-[3px] py-4">
            <div className="flex flex-col text-[12px]">
                <div className="role font-semibold text-[#707C95]">{email}</div>
            </div>
        </div>
        ...
        <div className="col-5 w-[5%] flex justify-center">
